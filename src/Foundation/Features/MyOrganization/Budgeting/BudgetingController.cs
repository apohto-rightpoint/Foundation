...
namespace Foundation.Features.MyOrganization.Budgeting
{
    ...
    public class BudgetingController : PageController<BudgetingPage>
    {
        ...
        private readonly BudgetingControllerService _controllerService;

        public BudgetingController(BudgetingControllerService controllerService, IBudgetService budgetService, IOrganizationService organizationService, ICustomerService customerService)
        {
        ...
        {
            var viewModel = _controllerService.GetAddBudgetViewModel(currentPage);
        ...
        {
            var viewModel = _controllerService.GetEditBudgetViewModel(currentPage, budgetId);
        ...
        {
            var viewModel = _controllerService.GetAddBudgetToUserViewModel(currentPage);

            if (viewModel.NewBudgetOption == null)
            {
                return RedirectToAction("Index");
            }
