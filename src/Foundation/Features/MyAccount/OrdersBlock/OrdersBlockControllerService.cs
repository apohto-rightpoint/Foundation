...
{
    public class OrdersBlockControllerService
    {
        ...
        public OrdersBlockControllerService(IAddressBookService addressBookService, IOrderRepository orderRepository, IContentLoader contentLoader, ICustomerService customerService)
        {
        ...
        public OrderHistoryViewModel GetViewModel(OrderHistoryBlock currentBlock)
        {
